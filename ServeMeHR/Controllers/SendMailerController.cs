...
namespace ServeMeHR.Controllers
{
    public class SendMailerController : Controller
    {
        ...
        [HttpPost]
        public ViewResult Index(ServeMeHR.Models.MailModel _objModelMail)
        {
            if (ModelState.IsValid)
            {
                ...
                smtp.Credentials = new System.Net.NetworkCredential(mailFrom, fromPass);// Enter seders User name and password
