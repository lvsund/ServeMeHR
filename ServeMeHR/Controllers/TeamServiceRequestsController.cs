    ...
    public class TeamServiceRequestsController : Controller
    {
        ...
        public async Task<ActionResult> Index(string StatusType, string searchString)
        {
            ...
            serviceRequests = from sr in db.ServiceRequests
                              ...
                              join t in db.Teams on sr.Team equals t.Id
                              join tm in db.TeamMembers on t.Id equals tm.Team
                              join m in db.Members on tm.Member equals m.Id
        ...
        // GET: TeamServiceRequests/Details/5
